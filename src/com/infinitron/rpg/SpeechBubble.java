...
public class SpeechBubble implements Serializable {
        ...
        public synchronized void draw(Canvas canvas, Sprite costume, Activity activity) {
        ...
        private void calculateDrawPosition(Activity activity) {
                ...
                if (pinPointRight.x + speechBubblePicWidth > 500) {
 ...
 /*       private void calculatePinPoints(Costume costume, Canvas canvas) {
        ...
        private void drawSpeechBubble(Sprite costume, Canvas canvas, Activity activity2) {
